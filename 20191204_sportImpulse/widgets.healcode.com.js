  ...
  window.healcodeInitialize = function(widgets) {
    ...
    function hcWidgetJsLoad() {
      ...
      function storeLinkDeployURL() {
        ...
        hcjq.ajax({
          url: 'https://cart.healcode.com/link_deploys/store.json',
      ...
      function preWidgetScripts() {
        return [{
          ...
          yep: ['https://assets.healcode.com/assets/moment.hcjq-513e187e05143dbe64771dd553de166b7ca2f4b1e62363723471e2f0d75a247d.js', 'https://assets.healcode.com/assets/pignose.calendar.hcjq-2e9dca214c186de998f67e14a9ac13b1415b63c22c6e98eea371b42b6f1be035.js', 'https://assets.healcode.com/assets/widgets/pignose.calendar.hcjq-a8a9160b4852572f4f8e5f65a90dd25f2f8d12fa2f4004ef136e032fd501974e.css']
        }, {
          test: !window.bwScheduleVersion1 && widgetCheck.schedule(),
          yep: ['https://assets.healcode.com/assets/widgets/schedule/version_1-83ffd1955d529136073e4f1b5d2b264b156686866e38dc232c0b76967f95ed89.js', 'https://assets.healcode.com/assets/widgets/schedule/load_markup-2e8c36a6b86a5bdae6dbd4f256080b872bf2f90064c45b4a3e43c7c9de01c91b.js', 'https://assets.healcode.com/assets/widgets/schedule/version_1-f1336a76d80e6ac42c74ff3d8245eeb25d3bf7c9d6e74b9ce47579c8bc028669.css', 'https://assets.healcode.com/assets/widgets/schedule/filter-c24a27e81a6e99f7e57e00a82416171ab4aed54e1424cfaf20c75aca306ea7e0.js']
        }, {
          ...
          yep: 'https://assets.healcode.com/assets/widget-cbceb109779efc8b92ca9fff2f25bc524db5be728246eab0becfc98630ead69e.js',
          callback: function(url, result, key) {
      ...
      function registerHealcodeWidgetCustomElement($, loadCounter) {
        ...
        function createLink(containerElement, linkType, linkLoadCounter) {
          ...
          link.dataURL  = 'https://cart.healcode.com/sites/' + link.siteID + '/';
        ...
        function createGiftCardLink(link, installer) {
          apiPredicate('https://cart.healcode.com/links/sell_giftcard_with_cart/' + link.siteID + '/' + link.itemID, function (data) {
            var linkHTML = '';
        ...
        healcodeWidget.requestURL = function() {
          return 'https://widgets.healcode.com/widgets/' + this.type() + '/' + this.widgetId() + '.json';
        };
